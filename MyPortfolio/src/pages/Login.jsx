    ...
    <div className='min-h-screen flex items-center justify-center px-4 md:px-0 py-10'>
      <div className='gradient-border rounded-md flex flex-col w-[80%] md:max-w-[25%] shadow-2xl'>
        <h1 className='text-2xl my-3 font-bold'>
          <span className='text-glow'> Log-In To </span><span className='text-primary'> Vagabond </span>
        </h1>
        ...
        <NavLink to='/register'>
          <button className='my-3 underline underline-offset-2 cursor-pointer' > Make Your Portfolio </button>
        </NavLink>
      </div>
    </div>
  )
